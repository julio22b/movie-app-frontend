...
const FilmPage: React.FC<props> = ({ headerRef }) => {
    ...
    const { error, loading, movie, backdrop } = useSelector((state: RootState) => state.popularMovies.movie_for_page);
                        ...
                        <section className='reviews'>
                            ...
                            {movie.reviews.length ? (
                                movie.reviews.map((review: Review) => (
                                    <FilmReview movieTitle={movie.title} key={review._id} {...review} />
                                ))
                            ) : (
